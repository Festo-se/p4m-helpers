...
public final class CommandLineOptions {
    ...
    /**
     * Gets the default command line options to be used with an Apache Commons CLI parser.
     *
    ...
    public static Options getDefaultOptions() {
        ...
        options.addOption(Option.builder("l")
                ...
                .longOpt("logConfig")
                .type(String.class)
                .desc("Path to logback configuration file. Do not name it 'logback.xml'! If not provided, a default configuration is used.")
                .build());
