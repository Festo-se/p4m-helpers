 ...
 *
 * <p>
 * This concept is related to {@link ValueDelegate} but the implementation
 ...
 * performing some calculations on them). Use {@code ValueDelegate} when
...
public class ConnectedProperty extends Property {
  ...
  /**
   * Create a {@code ConnectedProperty} with the given <i>idShort</i>
   * and value type.
   *
   ...
   *
   * <p>
   * If this property is to be read later, at least one value supplier must be
   * added.
   *
   * @param name     Uniquely identifies this value supplier among all suppliers
   ...
   *
   * <p>
   * If this property is to be written later, at least one value consumer must be
   * added.
   *
   * @param name     Uniquely identifies this value consumer among all consumers
   *                 added to this property.
