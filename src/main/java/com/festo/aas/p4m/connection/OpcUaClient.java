...
public final class OpcUaClient {
     ...
     * {@link OpcUaClientFactory#createClient(String, org.eclipse.basyx.vab.protocol.opcua.connector.ClientConfiguration)}
     ...
     * should the method require any arguments, must provide a value of the correct data type for each
     * of those.<br>
     ...
     * List&lt;Object&gt; returnedList = opcUaClient.invokeMethod(objectNodeId, methodNodeId, firstArgument, secondArgument);
