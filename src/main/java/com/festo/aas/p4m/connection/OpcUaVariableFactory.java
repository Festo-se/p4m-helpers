/*******************************************************************************
 * Copyright (C) 2021 the CanvAAS authors
 *
 ...
 *
 * <p>
 * The cache is indexed by {@link OpcUaClient} and {@link NodeId}. The node's data type or cache
...
public class OpcUaVariableFactory {
    ...
    /**
     * Retrieves an {@link OpcUaVariable} matching the given client and nodeId from the cache or creates
     * and caches a new one.
     *
     * @param client        The client used to retrieve this variable.
     * @param nodeId        The nodeId of the variable.
     * @param dataType      The variable's type. See {@link IOpcUaClient} for details.
     * @param cacheDuration The duration for which the variable's value will be cached.
     *
     * @return Either a new or cached <code>OpcUaVariable</code>.
     */
    ...
    /**
     * Creates a new {@link OpcUaVariable}. It will never be taken from cache nor will the created
     ...
     * @param cacheDuration The duration for which the variable's value will be cached.
     *
     * @return A new <code>OpcUaVariable</code>.
     */
